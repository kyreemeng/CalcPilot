...
export const financeTools: FinanceToolConfig[] = [
...

  {
    ...
    shortDesc: 'Convert hourly or annual USD pay to monthly take-home after tax.',
    ...
    currency: 'USD',
    fields: [
      { key: 'hourly', label: 'Hourly wage', type: 'money', defaultValue: 22.5, prefix: '$', min: 0, step: 0.25 },
    ...
    breakdown: [
      { key: 'gross', label: 'Gross / month' },
      { key: 'tax', label: 'Tax withheld' },
      { key: 'deductions', label: 'Deductions' },
      { key: 'net', label: 'Take-home / month' },
    ...
    howTo: {
      title: 'How to use this calculator',
      steps: [
        'Enter your hourly wage (for example $22.50) and hours per week.',
        'Set your effective tax rate and any monthly pre-tax deductions.',
        'Read monthly take-home after tax, plus weekly and annual gross equivalents.',
      ],
    },
    understanding: {
      title: 'Understanding your results',
      desc: 'Annual gross is <strong>hourly wage × hours per week × 52</strong>. Divide by 12 for <strong>monthly gross</strong>, then subtract your <strong>effective tax rate</strong> and <strong>pre-tax deductions</strong> to estimate <strong>USD monthly take-home</strong>. This matches common questions like “$22.50 an hour is how much a month after taxes.” Your effective rate is an average planning figure, not a full W-4 / payroll engine. Pair this with the <a href="/finance/mortgage-calculator">mortgage calculator</a> or <a href="/finance/savings-calculator">savings calculator</a> to plan housing and savings from net pay.',
    },
    hasAmortization: false,
    factors: {
      title: 'What factors affect your take-home pay',
      cards: [
        { name: 'Hourly wage', desc: 'Higher hourly pay raises annual, monthly and weekly gross before tax.' },
        { name: 'Hours per week', desc: 'More hours increase annual gross; overtime is not modeled separately.' },
        { name: 'Tax rate & deductions', desc: 'A higher effective tax rate or larger pre-tax deductions reduce monthly take-home.' },
      ],
    },
    examples: {
      title: 'Worked examples',
      cards: [
        { title: '$22.50 an hour after tax', input: '$22.50/hr × 40 hrs/week, 22% tax, $200 deductions', result: '≈ $2,842 take-home per month (planning estimate)' },
        { title: 'USD monthly from hourly', input: '$25/hr × 40 hrs at 20% effective tax', result: 'Gross ≈ $4,333/mo before deductions' },
      ],
    },
    faqs: [
      { q: 'How much is $22.50 an hour a month after taxes?', a: 'At 40 hours/week, $22.50/hr is $46,800 gross per year (~$3,900/month gross). With a 22% effective tax rate and $200 monthly pre-tax deductions, take-home is about $2,842/month. Change the inputs above to match your hours and tax rate.' },
      { q: 'How do I convert hourly wage to a USD monthly salary?', a: 'Multiply hourly wage × hours per week × 52, then divide by 12. This calculator does that and applies your effective tax rate and deductions for an estimated monthly take-home.' },
      ...
      { q: 'How is tax calculated?', a: 'The calculator applies your effective tax rate to monthly gross pay. Your effective rate is the average you actually pay, not your top marginal bracket.' },
    ...
    related: ['savings-calculator', 'compound-calculator', 'loan-calculator'],
  },
