...
export const converterTools: ConverterConfig[] = [
...

  {
    ...
    seo: {
      title: 'Data Converter — KB to MB, MB to GB (Kilo to Mega) | CalcPilot',
      description: 'Free data converter: kilo to mega (KB to MB), MB to GB and TB using binary units (1024). Instant bidirectional results — no sign-up.',
    },
